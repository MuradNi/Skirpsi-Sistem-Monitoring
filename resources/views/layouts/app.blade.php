...
<body class="bg-gray-50 text-gray-700 antialiased flex flex-col min-h-screen">
  ...
  <footer id="kontak" class="bg-neutral-950 text-gray-400 py-16 border-t border-gray-900">
      ...
      <div class="space-y-4">
        ...
        <ul class="space-y-2 text-xs">
          ...
          <li class="flex items-center gap-2">
            <svg class="w-4 h-4 text-primary shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
            <a href="https://www.instagram.com/sd_perguruan_buddhi/" target="_blank" class="hover:text-primary transition">@sd_perguruan_buddhi</a>
          </li>
        </ul>
      </div>

      <div class="space-y-4">
        <h4 class="font-bold text-white text-sm uppercase tracking-wider">Ikuti Kami</h4>
        <a href="https://www.instagram.com/sd_perguruan_buddhi/" target="_blank"
           class="flex items-center gap-3 bg-gradient-to-r from-purple-900/40 to-pink-900/40 border border-pink-800/30 rounded-xl p-3 hover:from-purple-800/50 hover:to-pink-800/50 transition group">
          <div class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0" style="background: linear-gradient(135deg, #833ab4, #fd1d1d, #fcb045);">
            <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
          </div>
          <div>
            <p class="font-bold text-xs text-white group-hover:text-pink-300 transition">Instagram</p>
            <p class="text-[10px] text-gray-400">@sd_perguruan_buddhi</p>
          </div>
        </a>
        <div class="flex items-center gap-3 mt-3">
          <div class="w-10 h-10 bg-indigo-900/40 text-indigo-400 rounded-xl flex items-center justify-center flex-shrink-0"><i data-lucide="school" class="w-5 h-5"></i></div>
          <div>
    ...
    <div class="max-w-7xl mx-auto px-6 border-t border-gray-900 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between text-xs gap-4">
      ...
      <a href="https://www.instagram.com/sd_perguruan_buddhi/" target="_blank"
         class="flex items-center gap-2 text-gray-500 hover:text-pink-400 transition">
